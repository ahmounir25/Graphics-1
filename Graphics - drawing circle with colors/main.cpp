...
{
    midpointLine(hdc,xc+x,yc+y,xc,yc,RGB(190,0,0));
    midpointLine(hdc,xc-x,yc+y,xc,yc,RGB(1,1,190));
    midpointLine(hdc,xc+x,yc-y,xc,yc,RGB(0,100,0));
    midpointLine(hdc,xc-x,yc-y,xc,yc,RGB(1,250,1));

    midpointLine(hdc,xc-y,yc+x,xc,yc,RGB(0,100,0));
    midpointLine(hdc,xc+y,yc-x,xc,yc,RGB(1,1,190));
    midpointLine(hdc,xc+y,yc+x,xc,yc,RGB(190,0,0));
